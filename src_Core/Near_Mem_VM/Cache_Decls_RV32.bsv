...
typedef       128   Word128_Sets_per_Cache;    // CSets_per_Cache * Word128s_per_CLine
typedef         7   Bits_per_Word128_Set_in_Cache;    // Bits_per_CSet_in_Cache + Bits_per_Word128_in_CLine
typedef        23   Bits_per_CTag;    // Bits_per_PA - (Bits_per_CSet_in_Cache + Bits_per_Byte_in_CLine)
...
Integer        word128_sets_per_cache =      128;    // CSets_per_Cache * Word128s_per_CLine
Integer  bits_per_word128_set_in_cache =        7;    // Bits_per_CSet_in_Cache + Bits_per_Word128_in_CLine
Integer                 bits_per_ctag =       23;    // Bits_per_PA - (Bits_per_CSet_in_Cache + Bits_per_Byte_in_CLine)
...
Integer         addr_hi_cset_in_cache =       10;    // addr_lo_cset_in_cache + Bits_per_CSet_in_Cache - 1

Integer  addr_lo_word128_set_in_cache =        4;    // addr_hi_byte_in_word128 + 1
Integer  addr_hi_word128_set_in_cache =       10;    // addr_lo_word128_set_in_cache + Bits_per_Word128_Set_in_Cache - 1

Integer                  addr_lo_ctag =       11;    // addr_hi_cset_in_cache + 1
