...
typedef       256   Word64_Sets_per_Cache;    // CSets_per_Cache * Word64s_per_CLine
typedef         8   Bits_per_Word64_Set_in_Cache;    // Bits_per_CSet_in_Cache + Bits_per_Word64_in_CLine
...
Integer         word64_sets_per_cache =      256;    // CSets_per_Cache * Word64s_per_CLine
Integer  bits_per_word64_set_in_cache =        8;    // Bits_per_CSet_in_Cache + Bits_per_Word64_in_CLine
...
Integer   addr_hi_word64_set_in_cache =       10;    // addr_lo_word64_set_in_cache + Bits_per_Word64_Set_in_Cache - 1
